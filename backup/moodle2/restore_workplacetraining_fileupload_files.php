 ...
 */
class restore_workplacetraining_fileupload_files extends restore_execution_step {
    /**
    ...
    protected function define_execution() {
        ...
        foreach ($newitems as $newitem) {
            $olditemid = $this->get_mappingid('workplacetraining_section_item', $newitem->newid);
            ...
            foreach ($responses as $response) {
                if ($olditemid) {
                    ...
                    if ($olditemid != $newitem->newid) {
                        $fs = get_file_storage();
                        $files = $fs->get_area_files($newcontextid, 'mod_workplacetraining', $oldfilearea, false, '', false);
