...
use mod_workplacetraining\completion\custom_completion;
...
/**
 * Unit tests for workplace training custom completion.
 *
 * @package    mod_workplacetraining
 * @copyright  Pelorus Labs
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers \mod_workplacetraining\completion\custom_completion
 */
final class custom_completion_test extends \advanced_testcase {
    ...
    public function test_completion_no_required_items(): void {
        ...
        // Create workplace training with completion enabled.
        $workplacetraining = $this->getDataGenerator()->create_module('workplacetraining', [
            'course' => $course->id,
            'completion' => COMPLETION_TRACKING_AUTOMATIC,
            'completiononrequired' => 1,
        ]);
        [$course, $cm] = get_course_and_cm_from_instance($workplacetraining, 'workplacetraining');
    ...
    public function test_completion_all_required_items_completed(): void {
        ...
        $item1->get_type_instance()->save_response($cm, $workplacetraining, $item1, $evaluation, 'Response 1');
        $item2->get_type_instance()->save_response($cm, $workplacetraining, $item2, $evaluation, 'Response 2');
    ...
    public function test_completion_ignores_optional_items(): void {
        ...
        $requireditem->get_type_instance()->save_response($cm, $workplacetraining, $requireditem, $evaluation, 'Response');
    ...
    public function test_completion_different_users(): void {
        ...
        $item->get_type_instance()->save_response($cm, $workplacetraining, $item, $evaluation1, 'User 1 Response');
