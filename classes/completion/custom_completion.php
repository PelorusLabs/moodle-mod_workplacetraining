...
namespace mod_workplacetraining\completion;

use core_completion\activity_custom_completion;

/**
 * Custom completion for workplace training.
 *
...
class custom_completion extends activity_custom_completion {
        ...
        switch ($rule) {
            case 'completiononrequired':
                ...
                $sql = "SELECT COUNT(DISTINCT r.itemid) as completed
                        ...
                        JOIN {workplacetraining_evaluations} e ON e.userid = r.userid
    ...
    public function get_custom_rule_descriptions(): array {
        return [
            'completiononrequired' => get_string('completiononrequired', 'workplacetraining'),
        ];
    }
